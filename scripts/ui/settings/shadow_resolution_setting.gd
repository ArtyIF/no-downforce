...
func on_value_changed(index: int):
	match index:
		0:
			# turning shadows off turns off the shadowmask as well
		...
		1:
			...
			$"/root/RaceTrack/Lighting/Sun".shadow_bias = 0.64
			RenderingServer.directional_shadow_atlas_set_size(512, true)
		2:
			$"/root/RaceTrack/Lighting/Sun".directional_shadow_max_distance = 20.0
			$"/root/RaceTrack/Lighting/Sun".shadow_bias = 0.32
			RenderingServer.directional_shadow_atlas_set_size(1024, true)
		3:
			$"/root/RaceTrack/Lighting/Sun".directional_shadow_max_distance = 20.0
			$"/root/RaceTrack/Lighting/Sun".shadow_bias = 0.16
			RenderingServer.directional_shadow_atlas_set_size(2048, true)
		4:
			$"/root/RaceTrack/Lighting/Sun".directional_shadow_max_distance = 20.0
			$"/root/RaceTrack/Lighting/Sun".shadow_bias = 0.08
